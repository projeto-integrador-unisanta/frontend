  ...
  return (
    <div className="min-h-screen bg-[#002B5B] flex flex-col text-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-20">
        ...
        <div className="text-white/40 text-xs font-medium tracking-widest uppercase flex flex-col items-center gap-4 mb-20">
        ...
        <section className="w-full max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            ...
            <button 
              ...
              className="hidden md:block bg-white/10 hover:bg-white/20 text-white font-bold py-2 px-6 rounded-full transition-colors text-sm uppercase tracking-wider border border-white/20"
            >
              Ver todos
            </button>
          </div>
